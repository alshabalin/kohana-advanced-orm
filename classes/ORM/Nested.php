 ...
 */
class ORM_Nested extends ORM {

    protected $_sorting = ['scope' => 'asc', 'lft' => 'asc'];
    ...
    /**
     * Return full tree of nodes, optionally for the scope
     *
    ...
    public function fulltree($scope = NULL)
    {
        if ($scope === NULL)
        {
            $this->where($this->scope_column, '=', $scope);
        }
        else
        {
            $this->order_by($this->scope_column, 'ASC');
        }
        $this->order_by($this->left_column, 'ASC');
     ...
     *
     * @return array array of sibling ORM_Nested objects
     */
     ...
     *
     * @param  mixed $node Instance of ORM_Nested or primary key value
     *
     * @return bool
     */
     ...
     *
     * @param  ORM_Nested $node Instance of ORM_Nested
     *
     * @return bool
     */
    public function add_child(ORM_Nested $node)
    {
